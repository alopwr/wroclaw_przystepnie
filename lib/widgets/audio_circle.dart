...
class AudioCircle extends StatefulWidget {
  AudioCircle(this.audio);
  final Media audio;
  @override
  _AudioCircleState createState() => _AudioCircleState();
}

class _AudioCircleState extends State<AudioCircle>
  ...
  Widget build(BuildContext context) {
    return CircleButton.withAnimatedIcon(
      icon: AnimatedIcon(
